...
bool initDisplay()
{
    ...
    Serial.printf("LCD hazir. Rotation: %d, LVGL: %dx%d\n",
                  TFT_ROTATION, SCREEN_WIDTH, SCREEN_HEIGHT);
    return true;
}
...
bool initLVGLDisplay()
{
    ...
    lv_display_set_buffers(disp, disp_buf, NULL, buffer_bytes,
...
bool initLVGLTouch()
{
    FT6336G_setRotation(TFT_ROTATION);
    FT6336G_setScreenSize(SCREEN_WIDTH, SCREEN_HEIGHT);
    // FT6336G_setDebug(true);   // gerekirse aç
